  ...
  return (
    <DashboardLayout title="Team Match Management">
      ...
      <Dialog open={!!declareResultMatch} onOpenChange={(open) => !open && setDeclareResultMatch(null)}>
        <DialogContent className="max-h-[90vh] overflow-auto scrollbar-thin scrollbar-thumb-primary scrollbar-track-secondary">
          <DialogHeader>
      ...
      >
        <DialogContent className="max-w-xl max-h-[90vh] overflow-auto scrollbar-thin scrollbar-thumb-primary scrollbar-track-secondary">
          <DialogHeader>
